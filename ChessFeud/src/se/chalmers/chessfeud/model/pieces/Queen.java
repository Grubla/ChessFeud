...
/**
 * The piece Queen.
 * Reprecents the Queen on the chessborad. Handles the logic for the
 * Queens movement.
 * @author Arvid
 *
 */
...
public class Queen extends Piece{
	...
	/**
	 * Returns a list of all the theoretical moves the Queen can do.
	...
	/*
	 * Takes the Queens current position and finds out which squares
	 * it can go on in all possible directions (vertical, horizontal, diagonally) 8 steps forward.
